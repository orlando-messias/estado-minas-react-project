  ...
  return (
    <header className='header-container'>
      <div className='left-content'>
        ...
        <img className='btn-sections-header btn-dark' src={BtnSectionsHeader} alt="Botão Seções Topo da Página" />
        <img className='btn-search-header btn-dark' src={BtnSearchHeader} alt="Botão Pesquisar Topo da Página" />
        <img src={Logo} className="sec" alt="Logo Estado de Minas" />
        <span className='section-name-header'>Política</span>
      </div>

      <div className='right-content'>
        <div className='btn-whatsapp btn-dark'>
        ...
        <div className='einstein-icon btn'>
